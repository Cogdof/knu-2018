...
## 개발요청 사항
### 기능추가
- [x] double down 기능이 있으면 좋겠네요. (Blackjack 에서 Double 이 뭔지 알아보세요.) _ need fix
...
- [x] double down시에 추가 금액보다 잔액이 적을 경우 All-in이 되어야 해요.
- [x] 딜러도 블랙잭을 일으킬 수 있어야 하고, 둘 다 블랙잭일 경우 무승부가 되어야 해요.
- [x] All in의 알림이 승부 결과의 알림보다 먼저 나타나요.

### 추가 기능구현 (여기에 써야 제가 확인이 가능하고 과제점수에 반영할 수 있습니다.)
- [ ] Split 기능을 만들어 주세요.
- [x] Surrender 기능을 만들어요.
- [x] 잔액이 0이 되면 revive 기능을 만들어요.
- [ ] Bet의 양에 따른 Chip UI 추가
